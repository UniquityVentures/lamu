...
// It intercepts "lamu-form-submit" Alpine.js custom events from child components (specifically those configured with [getters.FormBubbling] on [FormComponent].Attr).
...
//	     ActionURL: lamu.RoutePath("admin.UserCreate", nil),
...
func (e FormListenBoostedPost) Build(ctx context.Context) gomponents.Node {
  ...
  htmx.ajax('POST', u, {
	...
	return Div(Class("contents"),
		gomponents.Attr("@lamu-form-submit", expr),
