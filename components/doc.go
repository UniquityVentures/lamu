...
// for the Lamu application framework, constructed using maragu.dev/gomponents.
//
...
// 				Link:  lamu.RoutePath("admin.Dashboard", nil),
// 			}
// 		})
// 	}
//
...
// 		ActionURL: lamu.RoutePath("users.Create", nil),
