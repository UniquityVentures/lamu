				...
				components.ContainerColumn{
					Children: []components.PageInterface{
						...
						&components.FormListenBoostedPost{
							...
							ActionURL: lamu.RoutePath("otp.PhoneOtpRequestRoute", nil),
							Children: []components.PageInterface{
				...
				components.ContainerColumn{
					...
					Children: []components.PageInterface{
						...
						&components.FormListenBoostedPost{
							...
							ActionURL: lamu.RoutePath("otp.EmailOtpRequestRoute", nil),
							Children: []components.PageInterface{
								components.FormComponent[map[string]string]{
				...
				components.ContainerColumn{
					...
					Children: []components.PageInterface{
						...
						&components.FormListenBoostedPost{
							...
							ActionURL: getters.Format("%v?identifier=%v", getters.Any(lamu.RoutePath("otp.OtpVerifyRoute", nil)), getters.Any(getters.QueryEscape(getters.Key[string]("$in.Identifier")))),
							Children: []components.PageInterface{
								components.FormComponent[map[string]string]{
