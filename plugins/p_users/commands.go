...
func pluginCommandFactories() lamu.PluginFeatures[lamu.CommandFactory] {
	return lamu.PluginFeatures[lamu.CommandFactory]{
		Entries: []registry.Pair[string, lamu.CommandFactory]{
...
func createSuperuserCommand(config lamu.LamuConfig) *cobra.Command {
	cmd := &cobra.Command{
		Use:   "createsuperuser",
		Short: "Create a superuser account",
		RunE: func(cmd *cobra.Command, args []string) error {
			db, err := lamu.GetDbConn(config)
			if err != nil {
				return err
			}
...
func changePasswordCommand(config lamu.LamuConfig) *cobra.Command {
	cmd := &cobra.Command{
		Use:   "changepassword",
...
func revalidateUsersCommand(config lamu.LamuConfig) *cobra.Command {
	cmd := &cobra.Command{
