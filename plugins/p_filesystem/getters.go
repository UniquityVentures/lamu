...
func currentVNodeBackRoute() getters.Getter[string] {
	return func(ctx context.Context) (string, error) {
		...
		if n.ID == 0 {
			return lamu.RoutePath("filesystem.ListRoute", nil)(ctx)
		}
		if n.ParentID == nil {
			return lamu.RoutePath("filesystem.ListRoute", nil)(ctx)
		}
		return lamu.RoutePath("filesystem.BrowseRoute", map[string]getters.Getter[any]{
...
func listOrBrowseRoute(listRoute, browseRoute string) getters.Getter[string] {
	return func(ctx context.Context) (string, error) {
		n, _ := getters.Key[VNode]("vnode")(ctx)
		if n.ID == 0 {
			return lamu.RoutePath(listRoute, nil)(ctx)
		}
		return lamu.RoutePath(browseRoute, map[string]getters.Getter[any]{
...
func selectionBrowseRouteGetter(childRoute string) getters.Getter[string] {
	return withSelectionTarget(lamu.RoutePath(childRoute, map[string]getters.Getter[any]{
...
func rowOpenRoute() getters.Getter[string] {
	return func(ctx context.Context) (string, error) {
		...
		return lamu.RoutePath("filesystem.DetailRoute", map[string]getters.Getter[any]{
