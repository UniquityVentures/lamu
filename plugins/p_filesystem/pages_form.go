		...
		{Key: "filesystem.VNodeUpdateForm", Value: &components.ShellScaffold{
			...
			Children: []components.PageInterface{
				&components.FormListenBoostedPost{
					...
					ActionURL: lamu.RoutePath("filesystem.UpdateRoute", map[string]getters.Getter[any]{
										...
										&components.ContainerRow{
											...
											Children: []components.PageInterface{
												...
												&components.ButtonModalForm{
													...
													Url: lamu.RoutePath("filesystem.DeleteRoute", map[string]getters.Getter[any]{
														"id": getters.Any(getters.Key[uint]("vnode.ID")),
													}),
													FormPostURL: lamu.RoutePath("filesystem.DeleteRoute", map[string]getters.Getter[any]{
														"id": getters.Any(getters.Key[uint]("vnode.ID")),
													}),
		...
		{Key: "filesystem.VNodeMoveForm", Value: &components.ShellScaffold{
			...
			Children: []components.PageInterface{
				&components.FormListenBoostedPost{
					...
					ActionURL: lamu.RoutePath("filesystem.MoveRoute", map[string]getters.Getter[any]{
						"id": getters.Any(getters.Key[uint]("vnode.ID")),
					}),
					Children: []components.PageInterface{
						&components.FormComponent[VNode]{
								...
								&components.ContainerError{
									...
									Children: []components.PageInterface{
										&components.InputForeignKey[VNode]{
											...
											Url:         lamu.RoutePath("filesystem.MoveSelectRoute", nil),
