	...
	registerPluginPage("llm_assistant.AssistantMenu", &components.SidebarMenu{
		...
		Children: []components.PageInterface{
			&components.SidebarMenuItem{
				...
				Url:   lamu.RoutePath("llm_assistant.DefaultRoute", nil),
			},
			&components.SidebarMenuItem{
				Title: getters.Static("History"),
				Url:   lamu.RoutePath("llm_assistant.HistoryRoute", nil),
			},
			&components.SidebarMenuItem{
...
func (e *assistantChatRoot) Build(ctx context.Context) Node {
	...
	multiSelectUrl, _ := lamu.RoutePath("filesystem.MultiSelectRoute", nil)(ctx)
	multiUploadUrl, _ := lamu.RoutePath("filesystem.ChatUploadRoute", nil)(ctx)
