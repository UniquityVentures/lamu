...
func handleSkillImportRoute(w http.ResponseWriter, r *http.Request) {
	...
	lamu.NewDynamicView("llm_assistant.SkillsImportView").ServeHTTP(w, r)
}
...
func handleSkillImportPost(w http.ResponseWriter, r *http.Request) {
	...
	redirectURLGetter := lamu.RoutePath("llm_assistant.SkillsDetailRoute", map[string]getters.Getter[any]{
