...
//	)
//
//	func createGreetCommand(config lamu.LamuConfig) *cobra.Command {
//		cmd := &cobra.Command{
//			Use:   "greet",
...
//	}
//
//	func pluginCommands() lamu.PluginFeatures[lamu.CommandFactory] {
...
//	lamu.Plugin{
//		CommandFactories: lamu.PluginStages(pluginCommands),
//	}
//
// # Cobra Reference
//
