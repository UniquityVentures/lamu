...
//
// Pages in Lamu represent frontend screens, navigation views, or widgets.
...
//
// You can build pages entirely in Go code using standard layouts and fields provided by lamu/components:
//
