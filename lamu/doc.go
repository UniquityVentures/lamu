...
//
//   - Users & Auth: See [github.com/UniquityVentures/lamu/plugins/p_users] for user management and role controls.
//   - Dashboard: See [github.com/UniquityVentures/lamu/plugins/p_dashboard] for the centralized launchpad portal.
//   - XLSX Export: See [github.com/UniquityVentures/lamu/plugins/p_export] for spreadsheet export features.
//   - Filesystem: See [github.com/UniquityVentures/lamu/plugins/p_filesystem] for local/GCS virtual filesystem drives.
//   - Google GenAI: See [github.com/UniquityVentures/lamu/plugins/p_google_genai] for Gemini AI client loaders.
//   - Live Reload: See [github.com/UniquityVentures/lamu/plugins/p_livereloading] for hot browser refreshes.
//   - LLM Assistant: See [github.com/UniquityVentures/lamu/plugins/p_llm_assistant] for interactive AI chat prompts.
//   - OTP Recovery: See [github.com/UniquityVentures/lamu/plugins/p_otp] for SMS/email one-time password recovery.
//   - PWA Support: See [github.com/UniquityVentures/lamu/plugins/p_pwa] for Progressive Web App capabilities.
package lamu
